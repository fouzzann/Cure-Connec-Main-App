...
class NephrologistDoctorCard extends StatelessWidget {
  final QueryDocumentSnapshot doc;
  final FavoritesController favoritesController;

  const NephrologistDoctorCard({
    Key? key,
    required this.doc,
        ...
        child: Padding(
          ...
          child: Stack(
            children: [
              Row(
                children: [
                  _buildDoctorImage(data),
                  const SizedBox(width: 12),
                  _buildDoctorDetails(data, isFavorite),
                ],
              ),
  ...
  // Doctor Image Widget
  Widget _buildDoctorImage(Map<String, dynamic> data) {
    return ClipRRect(
  ...
  Widget _buildDoctorDetails(Map<String, dynamic> data, bool isFavorite) {
    return Expanded(
      child: Column(
