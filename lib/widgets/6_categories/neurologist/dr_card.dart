...
class NeurologistDoctorCard extends StatelessWidget {
  final QueryDocumentSnapshot doc;
  final FavoritesController favoritesController;

  const NeurologistDoctorCard({Key? key, required this.doc, required this.favoritesController}) : super(key: key);
